...
function subscribeFinalizedBlocks(instanceId, api) {
    return (0, index_js_1.memo)(instanceId, () => api.derive.chain.subscribeFinalizedHeads().pipe((0, rxjs_1.mergeMap)((header) => api.derive.chain.getBlock(header.createdAtHash || header.hash))));
}
