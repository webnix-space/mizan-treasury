    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>464/503</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>211/257</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>461/499</span>
            </div>
...
<a name='L1425'></a><a href='#L1425'>1425</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >        decryptedValue = encryptedValue;</span>
        const reEncrypted = <span class="cstat-no" title="statement not covered" >await encryption.encrypt(encryptedValue);</span>
...
<span class="cstat-no" title="statement not covered" >          decryptedValue = await encryption.decryptWithPassword(encryptedValue, password);</span>
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (needsReEncryption) {
        const reEncrypted = <span class="cstat-no" title="statement not covered" >await encryption.encrypt(decryptedValue);</span>
<span class="cstat-no" title="statement not covered" >        await subLevel.put(key, reEncrypted);</span>
      }
&nbsp;
      const value = superjson.parse&lt;V&gt;(decryptedValue);
...
const validateExportPassword = (password: string): void =&gt; {
  try {
    ...
    const message = error instanceof Error ? error.message : <span class="branch-1 cbranch-no" title="branch not covered" >'Invalid export password';</span>
