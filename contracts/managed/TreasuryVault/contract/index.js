...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.secretOwnerKey) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named secretOwnerKey');
    }
    ...
    this.circuits = {
      initialize: (...args_1) => {
        ...
        const initialAmount_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('initialize',
                                     'argument 1 (as invoked from Typescript)',
                                     'TreasuryVault.compact line 9 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(initialAmount_0),
      ...
      deposit: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('deposit',
                                     'argument 1 (as invoked from Typescript)',
                                     'TreasuryVault.compact line 17 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      withdraw: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('withdraw',
                                     'argument 1 (as invoked from Typescript)',
                                     'TreasuryVault.compact line 25 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(amount_0) === 'bigint' && amount_0 >= 0n && amount_0 <= 18446744073709551615n)) {
  ...
  _secretOwnerKey_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.secretOwnerKey(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('secretOwnerKey',
                                 'return value',
                                 'TreasuryVault.compact line 6 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _initialize_0(context, partialProofData, initialAmount_0) {
  ...
  _deposit_0(context, partialProofData, amount_0) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('TreasuryVault.compact line 21 char 24: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
    ...
    __compactRuntime.assert((t_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             ...
                                                                                             [
                                                                                              ...
                                                                                              { popeq: { cached: false,
                                                                                                         result: undefined } }]).value),
                             t_0 >= amount_0),
                            'Insufficient vault reserves');
    __compactRuntime.assert(!this._equal_0(this._secretOwnerKey_0(context,
                                                                  partialProofData),
                                           new Uint8Array(32)),
                            'Unauthorized private witness');
    let t_1, t_2;
...
const _dummyContract = new Contract({ secretOwnerKey: (...args) => undefined });
