...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      deposit: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('deposit',
                                     ...
                                     'TreasuryVault.compact line 20 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      withdraw: (...args_1) => {
        ...
        if (!(caller_key_0.buffer instanceof ArrayBuffer && caller_key_0.BYTES_PER_ELEMENT === 1 && caller_key_0.length === 32)) {
          __compactRuntime.typeError('withdraw',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(amount_0).concat(_descriptor_1.toValue(caller_key_0)),
  ...
  initialState(...args_0) {
    ...
    const initial_balance_0 = args_0[2];
    ...
    if (!(owner_0.buffer instanceof ArrayBuffer && owner_0.BYTES_PER_ELEMENT === 1 && owner_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'TreasuryVault.compact line 14 char 1',
                                 'Bytes<32>',
                                 owner_0)
    }
    if (!(typeof(initial_balance_0) === 'bigint' && initial_balance_0 >= 0n && initial_balance_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 2 (argument 3 as invoked from Typescript)',
                                 'TreasuryVault.compact line 14 char 1',
                                 'Uint<0..18446744073709551616>',
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(2n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(initial_balance_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _deposit_0(context, partialProofData, amount_0) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('TreasuryVault.compact line 22 char 29: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
  ...
  _withdraw_0(context, partialProofData, amount_0, caller_key_0) {
    __compactRuntime.assert(this._equal_0(caller_key_0,
